({
    ...
    allowDrop : function(cmp, event, helper) {
     ...
     allowDrop1 : function(cmp, event, helper) {
       event.preventDefault();
    },
    ...
    handleDrop : function(cmp, event, helper) {
     ...
     handleDrop1 : function(cmp, event, helper) {
         var srcId = cmp.get("v.draggedDivID");
        var rowIndex = parseInt(srcId.replace("dnd-r-", ""));
        alert(rowIndex)
        var table1Data = cmp.get("v.table1Data");
        ...
        var rowThatWasDragged1 = table2Data[rowIndex];
         console.log(rowThatWasDragged1);
        table1Data.push(rowThatWasDragged1);
